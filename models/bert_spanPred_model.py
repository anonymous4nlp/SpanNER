...
class BertNER(BertPreTrainedModel):
    def __init__(self, config,args):
        ...
        self.spanLen_embedding = nn.Embedding(args.max_span_len+1, self.spanLen_emb_dim, padding_idx=0)
    ...
    def forward(self,loadall, all_span_lens, all_span_idxs_ltoken, input_ids, token_type_ids=None, attention_mask=None):
        ...
        if not self.args.use_spanLen and not self.args.use_morphology:
        ...
        elif self.args.use_spanLen and not self.args.use_morphology:
            ...
            span_morph_rep = self.morph_embedding(morph_idxs) #(bs, n_span, max_span_len, dim)
